...
//Classes
const contatosLocalizacaoClasse = 'fonte-secundaria pt-4 text-center line flex-row d-flex justify-content-between';
const contatosLocalizacaoSecaoClasse = 'rounded pl-0 pr-4 pt-0 pb-0 text-left w-50 mt-3';
const contatosLocalizacaoTituloClasse = 'w-50 pl-0 text-left text-light font-weight-bold mt-0 d-flex flex-row ';
